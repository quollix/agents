...
- Put project engineering conventions in `~/Documents/workspace/agents/codex/workspace/references/*`, not in this file.
...
- The agent is allowed to edit the shared workspace skill files under `~/Documents/workspace/agents/codex/workspace/`.
